-- server/scripts/migrate_rules.sql
-- 初始分类规则迁移脚本 (修正版)
...
UPDATE PointsRule SET module='创作室', category='文本生成', calculationMethod='按页扣费', deductionLogic='根据大纲内容生成单页详细文案' WHERE code='slide_content';
