...
export const ImageUploader: React.FC<ImageUploaderProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      <div 
          onClick={handleClick}
          className={`w-full border-2 border-dashed border-slate-300 hover:border-rose-400 hover:bg-rose-50/30 transition-all rounded-lg cursor-pointer flex flex-col items-center justify-center text-center p-8 bg-slate-50 ${isUploading ? 'opacity-50 pointer-events-none' : ''}`}
      >
          {isUploading ? (
